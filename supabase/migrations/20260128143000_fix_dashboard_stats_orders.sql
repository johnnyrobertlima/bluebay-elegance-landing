-- Migration: Fix Dashboard Stats Orders Calculation
-- Date: 2026-01-28 14:30:00

-- Drop existing functions to avoid ambiguity (PGRST203)
DROP FUNCTION IF EXISTS get_commercial_dashboard_stats_v2(TIMESTAMP, TIMESTAMP, TEXT, TEXT, TEXT, TEXT);
DROP FUNCTION IF EXISTS get_commercial_dashboard_stats_v2(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT);
...
BEGIN
  ...
  -- 2. Orders Base
  -- Fix: Coalesce inputs for value calculation to prevent nulls
