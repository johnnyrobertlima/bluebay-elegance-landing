-- Migration: Update Dashboard V2 to include Representatives Support
-- Date: 2026-01-23 10:00:00
-- Purpose: Add representatives aggregation to get_commercial_dashboard_stats_v2
...
BEGIN
  ...
  -- New: Representative Aggregation
  rep_metrics AS (
    SELECT 
